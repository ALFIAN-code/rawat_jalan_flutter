...
class CreatePasienForm extends StatefulWidget {
  CreatePasienForm({
    super.key,
  });
  ...
  @override
  State<CreatePasienForm> createState() => _CreatePasienFormState();
}

class _CreatePasienFormState extends State<CreatePasienForm> {
            ...
            Flexible(
              child: ListView(
                ...
                children: [
                  ...
                  CustomTextField(
                      hint: 'john', controller: widget.namaPanggilanController),
                  const SizedBox(
                    height: 20,
                  ),
                      ...
                      child: CustomButton(
                        onTap: () {
                          Pasien pasien = Pasien(
                            ...
                            kelompokEtnis: widget.kelompokEtnisController.text,
                          ...
                          controller.createPasien(pasien);
                          Get.back();
                        },
                        color: mainColor,
                        child: Text(
